...
const Header = (props) => (
  <div className="bg">
    <div className="">
      ...
      <section className="container space animated animatedFadeInUp fadeInUp ">
        <div className="row">
          <div className="col-sm">
            <p className="font1">Payments made <span className="global">simple</span></p>
            <p className="intro">Send and receive money like chatting with your friends, all over the world and pay on stores websites with Qr codes</p>
          </div>
          <div className="col-sm">
